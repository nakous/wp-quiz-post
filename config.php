...
define("FIELD_THEME",     "wpqp_post_theme");
...
add_action( 'init', 'wpqp_add_new_list_image_size' );
function wpqp_add_new_list_image_size() {
    add_image_size( 'wpqp_quiz_list', 420, 360, false ); //List
}